...
public class Test23andMeCheckOut {
	...
	public void checkOut(String firstName, String lastName, String address, 
		...
		checkOutPage.checkAcceptTermBox();
		checkOutPage.clickSubmitOrderButton();
		Assert.assertEquals(true, checkOutPage.getEditPaymentButton().isDisplayed());
		driver.quit();
	}

	private void assertErrorMsg(WebDriver driver, Meand23CheckOutPage checkOutPage, String expectedErrorMsg) {
		Assert.assertEquals(true, checkOutPage.getErrorMessage().isDisplayed());
